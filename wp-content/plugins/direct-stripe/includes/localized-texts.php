...
$texts = array(
    'strings' => array(
        ...
        'valueAmountHint'       =>  __( 'For subscriptions, enter the pricing plan ID of a product (plan_xxx not prod_xxx), created in Stripe admin panel.', 'direct-stripe' ),
		...
		'buttonLocale'        	=>  __( 'Language', 'direct-stripe' ),
		'hintButtonLocale'    	=>  __( 'Select a locale language or leave empty to use Stripe auto language', 'direct-stripe' ),
        ...
        'dsButDAHint'           =>  __( 'Will display the amount in the modal form\'s button for payments and donation types of button. It won\'t display the amount for subscription types of buttons ( The amount can be inserted in the description ).', 'direct-stripe' ),
