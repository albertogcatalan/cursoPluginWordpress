...
<div class="' . $instance . '-success success">
    ...
    <h3 class="title" data-tid="elements_examples.success.title">' . __('Payment successful', 'direct-stripe') . '</h3>
    <p class="message"></p>
    <span id="ds-success-answer-' . $instance . '" class="directStripe_answer"></span>
    <a class="reset reset-success-' . $instance . '">
